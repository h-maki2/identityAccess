...
class ResendRegistrationConfirmationEmailApplicationServiceTest extends TestCase
{
    ...
    public function test_認証アカウントが本登録済みではない場合、ワンタイムトークンとワンタイムパスワードの再生成ができる()
    {
        ...
        $this->assertStringContainsString($actualDefinitiveRegistrationConfirmation->oneTimeToken()->tokenValue()->value, $this->catchedSendEmailDto->templateVariables['DefinitiveRegistrationCompletedUpdateUrl']);
