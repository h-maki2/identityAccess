...
use packages\application\authentication\definitiveRegistrationCompleted\display\DisplayDefinitiveRegistrationConfirmedUpdatePageApplicationService;
use packages\application\authentication\definitiveRegistrationCompleted\display\DisplayDefinitiveRegistrationConfirmedUpdatePageInputBoundary;
use packages\application\authentication\definitiveRegistrationCompleted\display\DisplayDefinitiveRegistrationConfirmedUpdatePageOutputBoundary;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(DefinitiveRegistrationConfirmedUpdateInputBoundary::class, DefinitiveRegistrationCompletedApplicationServicee::class);
